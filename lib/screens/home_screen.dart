...
class _HomeState extends State<Home> with WidgetsBindingObserver {
  ...
  Future<void> _readInboxOnce() async {
    final permissionGranted = await telephonyInstance.requestPhoneAndSmsPermissions;
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                            ...
                            child: const _ShortcutIcon(label: 'History', icon: Icons.history)),
                        const _ShortcutIcon(
                            label: 'Wallet',
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (_) => PdfEmailPage()),
                            );
                          },
                          ...
                          latest.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    ...
                                    final time = DateFormat('hh:mm a dd, MMM')
                                        .format(sms.receivedAt);

                                    // Tag logic: custom tag icon or default
                                    IconData tagIconData = Icons.label_outline;
                                    if (tagBox != null && sms.tag != null) {
                                      final customTagIconCode =
                                          tagBox.get('customTags')?[sms.tag];
                                      ...
                                      tagIconData =
                                          tagIconMap[sms.tag?.toLowerCase()] ??
                                              Icons.label_outline;
                                    }
        ...
        children: [
          CircleAvatar(
            ...
            backgroundColor: Color.fromRGBO(
                168, 168, 168, 0.20392156862745098),
